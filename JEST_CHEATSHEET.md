...
1. **Read test errors carefully** - Jest error messages are very helpful
2. **Use `test:watch` mode** - Instant feedback is powerful
3. **Test one thing at a time** - Small, focused tests
